                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            <form action="/create-role" method="post">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <input class="form-control @error('nama_role') is-invalid @enderror" id="inputName" name="nama_role" type="text" maxlength="50" placeholder="Nama Role" value="{{ old('nama_role') }}" required/>
                                        @error('nama_role')
