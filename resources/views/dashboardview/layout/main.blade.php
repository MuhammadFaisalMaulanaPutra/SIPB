    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ ($title === 'User') ? 'active' : '' }}">
                <a class="nav-link" href="dashboard-table-user">
                    <i class="bi bi-person"></i>
                    <span>User</span></a>
            </li>

            <li class="nav-item {{ ($title === 'Role') ? 'active' : '' }}">
                <a class="nav-link" href="dashboard-table-role">
                    <i class="bi bi-boxes"></i>
                    <span>Role</span></a>
            </li>

            <li class="nav-item {{ ($title === 'Bencana') ? 'active' : '' }}">
                <a class="nav-link" href="dashboard-table-bencana">
                    <i class="bi bi-disc"></i>
                    <span>Bencana</span>
                </a>
            </li>

            <li class="nav-item {{ ($title === 'Wilayah') ? 'active' : '' }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hai, {{ auth()->user()->nama_user }} </span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Lancana 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
